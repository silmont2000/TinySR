"""Model loading, image preprocessing, VAE encoding, and inference execution.

Extracted from models.quant.inference — these are general-purpose pipeline
utilities, not quantization-specific logic.
"""
