...
# Usage:  cd /data/disk2/xby/TinySR && bash script/sweep_alpha_real.sh
# ==============================================================================
...
GT_DIR="/data/disk2/xby/TinySR/dataset/StableSR_testsets/RealSRVal_crop128/test_HR"
CALIB_DIR="/data/disk2/xby/TinySR/dataset/StableSR_testsets/RealSRVal_crop128/test_LR"
...
RESULTS_FILE="logs/sweep_alpha_results_real.txt"
METRICS_LOG_DIR="logs/metrics/real"
...
for alpha in ${ALPHAS}; do
    ...
    dir="outputs/real/w${W_BITS}a${A_BITS}_svdq_r${SVDQ_RANK}_${QUANT_SCOPE}_a${alpha_int}"
